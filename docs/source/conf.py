# -*- coding: utf-8 -*-
#
# trail_mapper-mapper-django documentation build configuration file, created by
...
project = u'trail_mapper-mapper-django'
...
man_pages = [
    ('index', 'project_name', u'trail_mapper-mapper-django Documentation',
     [u'Phil Thisin'], 1)
]
